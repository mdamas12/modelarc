...
class ProjectResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'category_ref' => new CategoryResource($this->whenLoaded('categoryRef')),
            'subcategory_ref' => new SubcategoryResource($this->whenLoaded('subcategoryRef')),
            ...
            'gallery_changes' => GalleryChangeResource::collection($this->whenLoaded('galleryChanges')),
