          ...
          <div class="contact-aside__social-block">
            ...
            <div class="contact-aside__social">
              ...
              >
                ...
                >
                  <path
                    d="M24 5.457v13.909c0 .904-.732 1.636-1.636 1.636h-3.819V11.73L12 16.64l-6.545-4.91v9.273H1.636A1.636 1.636 0 010 19.366V5.457c0-2.023 2.309-3.178 3.927-1.964L12 10.582l6.073-4.089C19.691 2.279 24 3.434 24 5.457z"
                  />
                </svg>
              </a>
            </div>
